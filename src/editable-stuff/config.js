...
const mainBody = {
  ...
  middleName: "",
  lastName: "Arruda",
  message: "26, Biomedical Engineer. I love pizza, dark mode and python+django+react ❤️",
  icons: [
    {
      image: "fa-github",
...
const about = {
  show: true,
  heading: "About Me",
  imageLink: require("../editable-stuff/andre.png"),
  imageSize: 375,
  message:
...
const leadership = {
  ...
  images: [
    {
      img: require("../editable-stuff/andre.png"),
